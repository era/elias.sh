...
After a few days of letting one agent code and another review, I had something working. I called it [boitata](https://github.com/cats-of-the-world/boitata). The name comes from Brazilian native folklore, a fire snake that protects the forest. Of course, at that point, my workflow was generating so much code that I stopped reading the code. Every weekend I would spend some time testing the software and checking it seemed to work as I expected.
