...
The code for the WasmModule is a bit more complex than what I showed here, make sure to checkout the [plugin.rs](https://github.com/era/example-of-plugins-with-webassembly/blob/master/host-application/src/plugin.rs).
